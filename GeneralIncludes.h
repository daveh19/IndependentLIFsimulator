...
// Data reporters
#define RECORDER_NEURON_ID (1) /*(20)*/
#define RECORDER_SYNAPSE_ID (1) /*(100)*/ /*(201)*/ /* for multiple synaptic recordings this needs to be less than 400*/
...
#define MAX_TIME_STEPS (100000000) /*(12000000)*/ /*(12000000)*/ /*(300000)*/ /*no of timesteps, each of size dt*/

// Network schema
#define NO_EXC (8000) /*(10000)*/ /*(8000)*/ /*(400)*/ /*(10000)*/
//#define NO_INH (0)
...
#define J_EXT (10.) /*(10.186)*/ /*(11.046)*/ /*(10.23)*/ /*(10.186)*/ /*(6.215)*/ /*(8.9065)*/ /*(7.07)*/ /*(6.966) in-vivo*/ /*(7.07) 1hz in-vitro*/
...
#define LIF_REFRAC_TIME (1000) /*(0)*/ /*200*/ /*timesteps*/

// Synapse model specific
#define SYN_RHO_INITIAL (0.5) /*(0.164840)*/ /*(0.164844)*/ /*(0.16492)*/ /*(0.203586)*/ /*(1.0)*/
...
#define SYN_C_PRE (0.45) /*(0.56175)*/ /*(0.33705)*/ /*(0.5617539)*/
