...
#define J_EXT (10.186) /*(11.046)*/ /*(10.23)*/ /*(10.186)*/ /*(6.215)*/ /*(8.9065)*/ /*(7.07)*/ /*(6.966) in-vivo*/ /*(7.07) 1hz in-vitro*/
...
#define SYN_RHO_INITIAL (1) /*(0.164840)*/ /*(0.164844)*/ /*(0.16492)*/ /*(0.203586)*/ /*(1.0)*/
